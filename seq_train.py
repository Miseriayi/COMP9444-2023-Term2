    ...
    if epoch % 1000 == 0:
        ...
        with torch.no_grad():
            ...
            if not args.embed:
                ...
                lang.print_outputs(epoch, seq, state, hidden, target, output, gates)
            ### if embed, return values include gates_values ,output gates value
            sys.stdout.flush()
